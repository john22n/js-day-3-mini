...
// use apply here
// customer2.addToTotal.apply(addToTotal, [1, 3, 4]);
...
// Code here
var obj = {
  findpop: objWithFind.findProp.call(obj, 3)
}
...
objWithFilter.filter.call(obj, [1, 2, 3]);
...
// Code here
console.log(Array.prototype.filter.call([2, 35, 4], function() {
  return true
}));
...
// Code here
String.prototype.replace.apply([1, 2, 4]);
...
Person.prototype.addWeight = function(add) {
  this.weight += add;

}

var john = new Person("john", 23, 121);
...
var briansClone = new Person();

brian.addWeight(2)
briansClone.addWeight(4)
